-- Adminer 4.8.1 PostgreSQL 10.17 (Debian 10.17-1.pgdg90+1) dump

-- Kaggle - Formula 1 World Championship (1950 - 2020)
-- Description: Laboratory material [Database Systems Course, UFES](http://www.informatica.ufes.br) 
-- Courtesy: Vopani ([Kaggle](https://www.kaggle.com/rohanrao/formula-1-world-championship-1950-2020))
-- Credits: Rodrigo Laiola Guimaraes

DROP DATABASE IF EXISTS "db_f1";
...
CREATE TABLE "public"."circuits" (
    ...
    CONSTRAINT "circuits_circuitId" PRIMARY KEY ("circuitId")
) WITH (oids = false);

INSERT INTO "circuits" ("circuitId", "name", "location", "country", "lat", "lng", "alt") VALUES
...
CREATE TABLE "public"."constructors" (
    ...
    CONSTRAINT "constructors_constructorId" PRIMARY KEY ("constructorId")
) WITH (oids = false);
...
CREATE TABLE "public"."drivers" (
    ...
    "dob" date NOT NULL,
    "nationality" character varying(64) NOT NULL,
    CONSTRAINT "drivers_driverId" PRIMARY KEY ("driverId")
) WITH (oids = false);

INSERT INTO "drivers" ("driverId", "forename", "surname", "dob", "nationality") VALUES
...
CREATE TABLE "public"."gps" (
    ...
    CONSTRAINT "gps_pkey" PRIMARY KEY ("gpId")
) WITH (oids = false);

INSERT INTO "gps" ("gpId", "name") VALUES
...
CREATE TABLE "public"."races" (
    ...
    "circuitId" integer NOT NULL,
    "gpId" integer NOT NULL,
    CONSTRAINT "races_raceId" PRIMARY KEY ("raceId")
) WITH (oids = false);

INSERT INTO "races" ("raceId", "year", "round", "circuitId", "gpId") VALUES
(837,	1950,	5,	13,	37),
(968,	2016,	21,	24,	10),
(1035,	2020,	5,	9,	26),
(897,	2013,	17,	24,	10),
...
CREATE TABLE "public"."results" (
    ...
    CONSTRAINT "results_resultId" PRIMARY KEY ("resultId")
) WITH (oids = false);

INSERT INTO "results" ("resultId", "raceId", "driverId", "constructorId", "grid", "positionOrder", "points", "statusId") VALUES
(1,	18,	1,	1,	1,	1,	10,	1),
(2,	18,	2,	2,	5,	2,	8,	1),
(3,	18,	3,	3,	7,	3,	6,	1),
(4,	18,	4,	4,	11,	4,	5,	1),
...
CREATE TABLE "public"."seasons" (
    "year" integer NOT NULL,
    CONSTRAINT "seasons_year" PRIMARY KEY ("year")
) WITH (oids = false);
...
CREATE TABLE "public"."status" (
    ...
    CONSTRAINT "status_statusId" PRIMARY KEY ("statusId")
) WITH (oids = false);
...
ALTER TABLE ONLY "public"."races" ADD CONSTRAINT "races_circuitId_fkey" FOREIGN KEY ("circuitId") REFERENCES circuits("circuitId") NOT DEFERRABLE;
ALTER TABLE ONLY "public"."races" ADD CONSTRAINT "races_gpId_fkey" FOREIGN KEY ("gpId") REFERENCES gps("gpId") NOT DEFERRABLE;
ALTER TABLE ONLY "public"."races" ADD CONSTRAINT "races_year_fkey" FOREIGN KEY (year) REFERENCES seasons(year) NOT DEFERRABLE;

ALTER TABLE ONLY "public"."results" ADD CONSTRAINT "results_constructorId_fkey" FOREIGN KEY ("constructorId") REFERENCES constructors("constructorId") NOT DEFERRABLE;
ALTER TABLE ONLY "public"."results" ADD CONSTRAINT "results_driverId_fkey" FOREIGN KEY ("driverId") REFERENCES drivers("driverId") NOT DEFERRABLE;
ALTER TABLE ONLY "public"."results" ADD CONSTRAINT "results_raceId_fkey" FOREIGN KEY ("raceId") REFERENCES races("raceId") NOT DEFERRABLE;
ALTER TABLE ONLY "public"."results" ADD CONSTRAINT "results_statusId_fkey" FOREIGN KEY ("statusId") REFERENCES status("statusId") NOT DEFERRABLE;

-- 2021-08-11 17:28:04.393222+00
